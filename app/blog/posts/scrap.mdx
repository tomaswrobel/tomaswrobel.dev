...
<q>ScrapScript</q> je kódové označení pro problém nekompatibility. Jeho cílem je navrhnout podmnožinu ECMAScriptu, kterou
lze převést na bloky a zpět **co nejsnadněji**.

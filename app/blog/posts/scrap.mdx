...
export const updated = new Date(2025, 0, 17);
...
As Scrap doesn't have a VM, somehow it needs to delay block execution (like Scratch does), and control code execution. Most of that handles compiler, but still, some things must be done at runtime – setters, getters and throwing uncatchable errors do the job.
...
If you totally agree, and, by chance, you are a developer, consider [join the team](/blog/scrap-contribution-needed.mdx).